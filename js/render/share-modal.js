    ...
    <div class="modal share-modal" role="dialog" aria-modal="true" aria-label="分享长图">
      ...
      <div class="modal-body share-image-body">
        <div class="share-options-panel" aria-label="分享内容">
          ...
          <label class="share-options-row"><input type="checkbox" class="share-option-input share-include-annotations" data-share-option="includeAnnotations" ${
            currentOptions.includeAnnotations ? 'checked' : ''
          } /><span>包含 3D 标记</span></label>
        </div>
