...
6. For 3D-related releases, capture screenshots for foundation rise, carved geography, route highlight, building massing/dissolve, and route focus. Route hash and endpoints must match the persisted 2D route.
